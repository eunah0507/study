...
public class Image_2  extends Frame implements ActionListener{
	...
	String ss = "src/image/flower3.jpg";
	...
	public Image_2(String title)
	{
		...
		txt = new TextField("src/image/flower3.jpg", 20);
	...
	class XCanvas_3 extends Canvas
	{
		public void paint(Graphics g)
		{
			...
			case 확대:
				g.drawImage(img, 0, 0, img.getWidth(this) * 2,
			...
			case 상하:
				g.drawImage(img, 0, img.getHeight(this), img.getWidth(this),
										0, 0, 0, img.getWidth(this),
										img.getHeight(this), this);
				break;
	 ...
	 * 
	 * img - 랜더링 되는 지정 이미지. img가 null인 경우에는 아무것도 실시하지 않는다.
	 * x = x좌표
	 * y = y좌표
	 * width = 구형의 폭
	 * height = 구형의 높이
	 * obsever = 이미지가 떠한 변환되는 것이 통치되는 객체
	 * */
}
