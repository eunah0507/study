...
public class JRadio_2   extends JFrame  implements  ActionListener{

	private  JRadioButton  small, medium, large;
	private  JRadioButton  tea_1, tea_2, tea_3;
	private  JLabel text;
	private  JPanel  topPanel, sizePanel, twoPanel, boxPanel, resultPanel;
	...
	public JRadio_2() {
		...
		boxPanel.add(new JLabel("좋아하는 티를 선택 하시요!",JLabel.CENTER));
