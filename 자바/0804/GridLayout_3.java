...
public class GridLayout_3 {
	public static void main(String[] args) {
		...
		Panel p15 = new Panel();				p15.setBackground(new Color(160,150,240));
		Panel p16 = new Panel();				p16.setBackground(new Color(230,200,190));
		Panel p17 = new Panel();				p17.setBackground(new Color(240,120,100));
		...
		ff.add(new Label("Color.(160,150,240)"));		ff.add(p15);
		ff.add(new Label("Color.(230,200,190)"));		ff.add(p16);
		ff.add(new Label("Color.(240,120,100)"));		ff.add(p17);
